 ...
 */
package br.com.feira.Relatorios;
...
public class Rel_Comprovante {
    ...
    */
    public void getComprovante(List<HashMap> lista, boolean download){
        stream = this.getClass().getResourceAsStream("/Report/Comprovante.jasper");
        ...
        try {
            ...
            */
            ...
            response.setHeader("Content-disposition", tipo+"; filename=relatorio.pdf");
            ...
            Logger.getLogger(Rel_Comprovante.class.getName()).log(Level.SEVERE, null, ex);
