...
/**
 * Jersey REST client generated for REST resource:ComprovanteRESTFacade
 * [comprovante]<br>
 * USAGE:
 * <pre>
 *        ComprovanteClient client = new ComprovanteClient();
...
public class ComprovanteClient {
    ...
    public ComprovanteClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("comprovante");
    }
    ...
    public <T> T findRange_XML(Class<T> responseType, String max, String first) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{max, first}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findRange_JSON(Class<T> responseType, String max, String first) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{max, first}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
